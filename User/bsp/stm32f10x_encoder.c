...
#define ENCODER_PPR           (u16)(5000)   // number of pulses per revolution
...
#define MAX_COUNT 19000
#define ENCODER_TIM_PERIOD 20000
/* Private functions ---------------------------------------------------------*/
...
s16 ENC_Get_Electrical_Angle(void)
{
  ...
  temp = (s32)(TIM_GetCounter(ENCODER_TIMER)) * (s32)(UINT32_MAX / (4*ENCODER_PPR)); 
