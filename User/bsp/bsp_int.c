...
/*******************************************************************************
* Function Name  : App_MemFault_ISR
...
/*******************************************************************************
* Function Name  : App_BusFault_ISR
...
/*******************************************************************************
* Function Name  : App_UsageFault_ISR
...
void  BSP_IntHandlerDMA1_CH2      (void)  { DMA1_Channel2_IRQHandler();        }
void  BSP_IntHandlerDMA1_CH3      (void)  { DMA1_Channel3_IRQHandler();        }
...
void  BSP_IntHandlerUSB_LP_CAN_RX0(void)  { USB_LP_CAN1_RX0_IRQHandler();  }
...
void  BSP_IntHandlerEXTI9_5       (void)  { EXTI9_5_IRQHandler();         }
...
void  BSP_IntHandlerUSART3        (void)  { USART3_IRQHandler();          }
